...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 42 / 4.;
  ...
  public void robotInit() {
    ...
    // create left motor
    Spark leftMotor = setupSpark(1, Sides.LEFT, true);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupSpark(2, Sides.FOLLOWER, true));
    ...
    Spark rightMotor = setupSpark(3, Sides.RIGHT, false);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupSpark(4, Sides.FOLLOWER, false));
